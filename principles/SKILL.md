...
1. **Is the footer present and complete?** — NET; CURRENT STAGE with all six lines (BEFORE / NOW / CHANGED / NEXT / MEANT TO / FEYNMAN); all four lenses filled (or "n/a — why"); SUGGESTED ACTION with PASTE THIS + → TOWARD THE GOAL + → HEAVEN'S NET + FEYNMAN ("n/a" allowed, never skipped); both grades with evidence clauses; one blank line between every field.
