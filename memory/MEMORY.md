...
- [Confidence + risk footer on reports](feedback_confidence_risk_footer.md) — /explain, /auto, /prep, /spec reports end with CONFIDENCE + RISK grades tied to evidence; anything pending caps confidence below HIGH
